...
public class dlgSetLocal extends javax.swing.JDialog {
    Endereco endereco = new Endereco();
    private Boolean confirmed = false;
    
    public dlgSetLocal(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
        loadLocais();
    }
    ...
    private void initComponents() {
        ...
        lstLocais = new javax.swing.JList<>();
        ...
        jLabel1.setFont(new java.awt.Font("Segoe Fluent Icons", 0, 72)); // NOI18N
        ...
        lstLocais.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(lstLocais);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgSetLocal dialog = new dlgSetLocal(new javax.swing.JFrame());
    ...
    private javax.swing.JList<String> lstLocais;
